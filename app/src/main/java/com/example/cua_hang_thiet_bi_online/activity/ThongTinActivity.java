...
public class ThongTinActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng Nhonkingdom = new LatLng(21.058350, 105.730620);
        mMap.addMarker(new MarkerOptions().position(Nhonkingdom).title("Nhon King Dom").snippet("Dai hoc cong nghiep ha noi").icon(BitmapDescriptorFactory.defaultMarker()));
        mMap.setMapType(googleMap.MAP_TYPE_NORMAL);
        CameraPosition cameraPosition =new CameraPosition.Builder().target(Nhonkingdom).zoom(90).build();
        mMap.animateCamera(CameraUpdateFactory.newCameraPosition(cameraPosition));
        //mMap.moveCamera(CameraUpdateFactory.newLatLng(Nhonkingdom));
    }
}