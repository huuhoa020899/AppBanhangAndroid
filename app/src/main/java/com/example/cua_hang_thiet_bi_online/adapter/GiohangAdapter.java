...
import com.example.cua_hang_thiet_bi_online.activity.MainActivity;
...
public class GiohangAdapter extends BaseAdapter {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        viewHolder.txtgiagiohang.setText("Gia"+decimalFormat.format(giohang.getGiasp())+"D");
        Picasso.get().load(giohang.getHinhsp()).placeholder(R.drawable.noiimage)
        ...
        viewHolder.btnplus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                com.example.cua_hang_thiet_bi_online.activity.Giohang.EventUltil();
                if (slmoinhat>9) {
